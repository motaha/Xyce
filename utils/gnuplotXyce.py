...
#
# Date: $Date: 2013/05/29 21:13:53 $
# Revision: $Revision: 1.19 $
# Owner: $Author: erkeite $
#-------------------------------------------------------------------------------
"""
...
__date__ = "$Date: 2013/05/29 21:13:53 $"
...
def parsePlotOpts(plotopts,verbose=False):
  ...
  if verbose:
    if listopts:
      print "listopts = ", ; print listopts
    if dictopts:
      print "dictopts = ", ; print dictopts

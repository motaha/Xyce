...
//-----------------------------------------------------------------------------
// Filename       : $RCSfile: N_IO_OutputTecplot.h,v $
//
...
#ifndef Xyce_N_IO_OutputTecplot_h
#define Xyce_N_IO_OutputTecplot_h
...
class N_IO_OutputTecplot : public N_IO_OutputFileBase
{
  public:
  N_IO_OutputTecplot();
  ~N_IO_OutputTecplot();
...
#endif // Xyce_N_IO_OutputTecplot_h

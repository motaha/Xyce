...
//-------------------------------------------------------------------------
// Class         : N_IO_MeasureEquationEvaluation
// Purpose       : Evaluates an equations based on measured variables
// Special Notes :
// Creator       : Richard Schiek, SNL, Electrical and Microsystem Modeling
// Creation Date : 03/10/2009
//-------------------------------------------------------------------------
class N_IO_MeasureEquationEvaluation : public N_IO_MeasureBase
{
public:
  N_IO_MeasureEquationEvaluation( const N_UTL_OptionBlock & measureBlock, N_IO_OutputMgr &outputMgr );
  ~N_IO_MeasureEquationEvaluation() {};

...
//-----------------------------------------------------------------------------
// Filename       : $RCSfile: N_IO_OutputProbe.h,v $
//
...
#ifndef Xyce_N_IO_OutputProbe_h
#define Xyce_N_IO_OutputProbe_h
...
class N_IO_OutputProbe : public N_IO_OutputFileBase
{
  public:
  N_IO_OutputProbe();
  ~N_IO_OutputProbe();

...
//-----------------------------------------------------------------------------
// Filename       : $RCSfile: N_LAS_AztecOOSolver.h,v $
//
...
//-----------------------------------------------------------------------------
// Class         : N_LAS_AztecOOSolver
// Purpose       : AztecOO Interface
// Special Notes :
// Creator       : Robert Hoekstra, SNL, Parallel Compuational Sciences
// Creation Date : 05/18/04
//-----------------------------------------------------------------------------
class N_LAS_AztecOOSolver : public N_LAS_Solver
{

public:

  //Constructors
  N_LAS_AztecOOSolver( N_LAS_Problem & problem, N_UTL_OptionBlock & options );
...
private:
  ...
  bool setAztecCntl_( const N_UTL_Param & param );

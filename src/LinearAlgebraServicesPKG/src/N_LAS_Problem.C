...
// ---------------------
//
// Revision Number: $Revision: 1.7.6.3 $
//
...
// Creation Date : 05/20/04
//-----------------------------------------------------------------------------
N_LAS_Problem::N_LAS_Problem( const RefCountPtr<N_LAS_Matrix> & A, const RefCountPtr<N_LAS_MultiVector> & x, const RefCountPtr<N_LAS_MultiVector> & b )
 : A_(A),
   x_(x),
   b_(b),
...
//-----------------------------------------------------------------------------
N_LAS_Problem::N_LAS_Problem( const RefCountPtr<Epetra_Operator> & Op, const RefCountPtr<N_LAS_MultiVector> & x, const RefCountPtr<N_LAS_MultiVector> & b )
 : Op_(Op),
   x_(x),
   b_(b),
...
//-----------------------------------------------------------------------------
N_LAS_Problem::N_LAS_Problem( const RefCountPtr<Epetra_LinearProblem> & epetraProblem )

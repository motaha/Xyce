...
//-----------------------------------------------------------------------------
// Filename       : $RCSfile: N_PDS_Migrate.h,v $
//
            ...
            std::vector<KT> & oKeys )
{
  ...
  if( !comm_.isSerial() )
  {
    Epetra_MpiDistributor distributor( *(dynamic_cast<Epetra_MpiComm*>(comm_.petraComm())) );
            ...
            std::vector< RCP<DT> > & oData )
{
  ...
  if( !comm_.isSerial() )
  {
    Epetra_MpiDistributor distributor(
                *(dynamic_cast<Epetra_MpiComm*>(comm_.petraComm())) );

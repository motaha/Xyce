...
//-----------------------------------------------------------------------------
// Filename       : $RCSfile: N_PDS_Comm.h,v $
//
...
public:
  ...
  virtual bool bcast(long * val, const int & count, const int & root) const = 0;
  ...
  virtual bool rSend(const long * val, const int & count, const int & dest) const = 0;
  ...
  virtual bool iRecv(long * val, const int & count, const int & src) const = 0;
  ...
  virtual bool pack(const long * val, const int count, char * buf,
                    const int size, int & pos) const = 0;
  virtual bool pack(const std::size_t * val, const int count, char * buf,
                    const int size, int & pos) const = 0;
  ...
  virtual bool unpack(const char * buf, const int size, int & pos, long * val,
                      const int count) const = 0;
  virtual bool unpack(const char * buf, const int size, int & pos, std::size_t * val,
                      const int count) const = 0;

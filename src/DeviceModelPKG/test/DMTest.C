...
bool DeviceTestor::doAllocations()
{
  ...
  DevMgrPtr_ = N_DEV_DeviceMgr::factory();  // Allocate device manager:

  // Linear Algebra allocations:
  lasLAFactoryPtr_ = new N_LAS_LAFactory();

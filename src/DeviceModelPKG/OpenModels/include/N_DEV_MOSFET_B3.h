...
private:
  ...
  // MOSFET charge (Q) Row:
    ...
    vector< vector< int > > jacStampSpecial;    // for simulation

    // used when we need to merge the d' and or s' nodes
    vector< vector<int> > jacStampSpecialMerged;
    vector<int>           jacSpecialMap;
    vector< vector<int> > jacSpecialMap2;
    vector<int>           jacSpecialMergedMap;
    vector< vector<int> > jacSpecialMergedMap2;
};

...
private:
    static vector< vector< vector<int> > > jacStamp_v;
    static vector< vector<int> > jacMap_v;
    static vector< vector< vector<int> > > jacMap2_v;
...
// gate mid row:
    ...
    vector< vector< int > > jacStampIC;
    vector<int>  jacMapIC;
    vector< vector<int> > jacMapIC2;
...
//soi specific variables:
    ...
    list<SizeDependParam*> sizeDependParamList;
  ...
  public:
    Master (
      ...
      const std::string &dmName,
           ...
           SolverState & ss1,
           DeviceOptions & do1, int neVars)
      : Xyce::Device::DeviceTemplate<Model, Instance>(
           dn, cn, dmName, linearDev, ss1, do1, neVars)
    {

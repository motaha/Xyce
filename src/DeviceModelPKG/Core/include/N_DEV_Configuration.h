...
// ---------------------
//
// Revision Number: $Revision: 1.18.2.3 $
//
...
public:
  ...
  static const int numNodes();                                ///< Number of nodes must be provided in the deriving class
  static const int numOptionalNodes() {return 0;}             ///< Default number of optional nodes
  static const int numFillNodes() {return 0;}                 ///< Default number of fill nodes
  static const bool modelRequired() {return false;}           ///< By default, model is not required
  ...
  static const bool isLinearDevice();                         ///< Linear device flag must be provided in the deriving class
  static const bool isPDEDevice() {return false;}             ///< By default, device is not a PDE device
};
...
class Config : public Configuration
{
  ...
  public:
    ...
    ///
    Device *factory(const FactoryBlock &factory_block) /* override */
    {

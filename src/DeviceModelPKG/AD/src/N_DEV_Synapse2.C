...
template<>
ParametricData<Synapse2::Instance>::ParametricData()
{
...
template<>
ParametricData<Synapse2::Model>::ParametricData()
{
...
std::ostream &Model::printOutInstances(std::ostream &os) const
{
  ...
  os << endl;
  os << "Number of Synapse2 Instances: " << isize << endl;

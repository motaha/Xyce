...
//-----------------------------------------------------------------------------
// Filename       : $RCSfile: N_DEV_Neuron6_Factory.h,v $
//
...
#ifndef Xyce_N_DEV_Neuron6_Factory_h
#define Xyce_N_DEV_Neuron6_Factory_h
...
struct N_DEV_Neuron6
{
                                ...
                                N_DEV_DeviceOptions & do1)
  {
     ...
     const string className("N_DEV_Neuron6");
     ...
     N_DEV_Device * devptr =
       new Xyce::Device::DeviceTemplate<N_DEV_NeuronModel6, N_DEV_NeuronInstance6>
                   ( name,
                     className,
                     defaultModelName,
                     nameVec,

...
//-----------------------------------------------------------------------------
// Filename       : $RCSfile: N_DEV_Neuron_Factory.h,v $
//
...
#ifndef Xyce_N_DEV_Neuron_Factory_h
#define Xyce_N_DEV_Neuron_Factory_h
...
struct N_DEV_Neuron
{
                                ...
                                N_DEV_DeviceOptions & do1)
  {
     ...
     const string className("N_DEV_Neuron");
     ...
     N_DEV_Device * devptr =
       new N_DEV_NeuronMaster
       //new Xyce::Device::DeviceTemplate<N_DEV_NeuronModel, N_DEV_NeuronInstance>
                   ( name,
                     className,
                     defaultModelName,
                     nameVec,

...
UnitInfo unitTable[] =
{
  ...
  U_M2OM1,           U_INVALID,        "m**2/ohm",               "m$^{2}$/$\\Omega$",
  ...
  U_OHM,             U_INVALID,        "ohm",                    "$\\Omega$",
  U_OHMM2,           U_INVALID,        "ohm*m**2",               "$\\Omega-m^{2}$",
  U_OHMMICRON,       U_OHMMICRONM,     "ohm*micron",             "$\\Omega-\\mu$m",
  U_OHMMICRONM,      U_OHMMICRONM2,    "ohm*micron*m",           "$\\Omega-\\mu$m-m",
  ...
  U_SQUARES,         U_INVALID,        "squares",                "squares",

...
private:
  ...
  Model &       model_;         //< Owning model
    ...
    //vector< int > deltaHappEquInductorOffsets;

    int deltaMEquDeltaMOffset;
    //int deltaMEquDeltaHappOffset;
    vector< int > deltaMEquInductorOffsets;
    ...
    vector<double> branchCurrentSumHistory;  // these two vectors are used for 4th order RK
    vector<double> PFunctionHistory;         // integration of dM/dH.

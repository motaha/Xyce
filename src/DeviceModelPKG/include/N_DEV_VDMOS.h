...
//     35 total
  ...
  // V_dd Row:
    ...
    static vector< vector<int> > jacStamp_DC_SC_GC;
    static vector< vector<int> > jacStamp_DC_GC;
    static vector< vector<int> > jacStamp_SC_GC;
    static vector< vector<int> > jacStamp_DC_SC;
    static vector< vector<int> > jacStamp_GC;
    static vector< vector<int> > jacStamp_SC;
    static vector< vector<int> > jacStamp_DC;
    static vector< vector<int> > jacStamp;

    static vector<int> jacMap_DC_SC_GC;
    static vector<int> jacMap_DC_GC;
    static vector<int> jacMap_SC_GC;
    static vector<int> jacMap_DC_SC;
    static vector<int> jacMap_GC;
    static vector<int> jacMap_SC;
    static vector<int> jacMap_DC;
    static vector<int> jacMap;

    static vector< vector<int> > jacMap2_DC_SC_GC;
    static vector< vector<int> > jacMap2_DC_GC;
    static vector< vector<int> > jacMap2_SC_GC;
    static vector< vector<int> > jacMap2_DC_SC;
    static vector< vector<int> > jacMap2_GC;
    ...
    static vector< vector<int> > jacStamp_D1C_DC_SC_GC;
    static vector< vector<int> > jacStamp_D1C_DC_GC;
    static vector< vector<int> > jacStamp_D1C_SC_GC;
    static vector< vector<int> > jacStamp_D1C_DC_SC;
    static vector< vector<int> > jacStamp_D1C_GC;
    static vector< vector<int> > jacStamp_D1C_SC;
    static vector< vector<int> > jacStamp_D1C_DC;
    static vector< vector<int> > jacStamp_D1C;

    static vector<int> jacMap_D1C_DC_SC_GC;
    static vector<int> jacMap_D1C_DC_GC;
    static vector<int> jacMap_D1C_SC_GC;
    static vector<int> jacMap_D1C_DC_SC;
    static vector<int> jacMap_D1C_GC;
    static vector<int> jacMap_D1C_SC;
    static vector<int> jacMap_D1C_DC;
    static vector<int> jacMap_D1C;

    static vector< vector<int> > jacMap2_D1C_DC_SC_GC;
    static vector< vector<int> > jacMap2_D1C_DC_GC;
    static vector< vector<int> > jacMap2_D1C_SC_GC;
    static vector< vector<int> > jacMap2_D1C_DC_SC;
    static vector< vector<int> > jacMap2_D1C_GC;
    static vector< vector<int> > jacMap2_D1C_SC;
    static vector< vector<int> > jacMap2_D1C_DC;
    static vector< vector<int> > jacMap2_D1C;
};

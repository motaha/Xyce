...
//-----------------------------------------------------------------------------
// Filename       : $RCSfile: N_DEV_Neuron8_Factory.h,v $
//
...
#ifndef Xyce_N_DEV_Neuron8_Factory_h
#define Xyce_N_DEV_Neuron8_Factory_h
...
struct N_DEV_Neuron8
{
                                ...
                                N_DEV_DeviceOptions & do1)
  {
     ...
     N_DEV_Device * devptr =
       new Xyce::Device::DeviceTemplate<N_DEV_NeuronModel8, N_DEV_NeuronInstance8>
                   ( name,
                     className,
                     defaultModelName,
                     nameVec,

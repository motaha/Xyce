...
//-----------------------------------------------------------------------------
// Filename       : $RCSfile: N_DEV_Synapse2_Factory.h,v $
//
...
#ifndef Xyce_N_DEV_Synapse2_Factory_h
#define Xyce_N_DEV_Synapse2_Factory_h
...
//-----------------------------------------------------------------------------
// Class         : N_DEV_Synapse2
// Purpose       : Handles Synapse2s
//
// Special Notes :
//
...
//-----------------------------------------------------------------------------
struct N_DEV_Synapse2
{
  //---------------------------------------------------------------------------
  // Function      : factory
  // Purpose       : This is the factory function for the Synapse2 class.
  //
                                ...
                                N_DEV_DeviceOptions & do1)
  {
     ...
     const string className("N_DEV_Synapse2");
     const string defaultModelName("YSYNAPSE level 2");

     vector< pair<string,double> > nameVec;

     N_DEV_Device * devptr =
       new N_DEV_Synapse2Master
       //new Xyce::Device::DeviceTemplate<N_DEV_SynapseModel2, N_DEV_SynapseInstance2>
                   ( name,
                     className,
                     defaultModelName,
                     nameVec,

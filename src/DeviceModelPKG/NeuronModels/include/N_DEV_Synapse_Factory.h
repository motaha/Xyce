...
//-----------------------------------------------------------------------------
// Filename       : $RCSfile: N_DEV_Synapse_Factory.h,v $
//
...
#ifndef Xyce_N_DEV_SynapseFactory_h
#define Xyce_N_DEV_SynapseFactory_h
...
//-----------------------------------------------------------------------------
struct N_DEV_Synapse
{
  //---------------------------------------------------------------------------
  // Function      : factory
  // Purpose       : This is the factory function for the Synapse class.
  //
                                ...
                                N_DEV_DeviceOptions & do1)
  {
     ...
     const string className("N_DEV_Synapse");
     const string defaultModelName("YSYNAPSE level 1");

     vector< pair<string,double> > nameVec;

     N_DEV_Device * devptr =
       new N_DEV_SynapseMaster
       //new Xyce::Device::DeviceTemplate<N_DEV_SynapseModel, N_DEV_SynapseInstance>
                   ( name,
                     className,
                     defaultModelName,
                     nameVec,

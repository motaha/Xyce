...
//-----------------------------------------------------------------------------
// Filename       : $RCSfile: N_DEV_Neuron3_Factory.h,v $
//
...
#ifndef Xyce_N_DEV_Neuron3_Factory_h
#define Xyce_N_DEV_Neuron3_Factory_h
...
struct N_DEV_Neuron3
{
                                ...
                                N_DEV_DeviceOptions & do1)
  {
     ...
     const string className("N_DEV_Neuron3");
     const string defaultModelName("YNEURON level 3");

     //pair <string,double> p(string("Neuron3"), 1.0);
     vector< pair<string,double> > nameVec; //(1, p);

     N_DEV_Device * devptr =
       new Xyce::Device::DeviceTemplate<N_DEV_NeuronModel3, N_DEV_NeuronInstance3>
                   ( name,
                     className,
                     defaultModelName,
                     nameVec,

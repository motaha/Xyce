...
//-----------------------------------------------------------------------------
// Filename       : $RCSfile: N_DEV_Neuron4_Factory.h,v $
//
...
#ifndef Xyce_N_DEV_Neuron4_Factory_h
#define Xyce_N_DEV_Neuron4_Factory_h
...
struct N_DEV_Neuron4
{
                                ...
                                N_DEV_DeviceOptions & do1)
  {
     ...
     const string className("N_DEV_Neuron4");
     ...
     N_DEV_Device * devptr =
       new Xyce::Device::DeviceTemplate<N_DEV_NeuronModel4, N_DEV_NeuronInstance4>
                   ( name,
                     className,
                     defaultModelName,
                     nameVec,

...
std::map<int,std::string> & Instance::getStoreNameMap()
{
  ...
  if (storeNameMap.empty ())
  {
    ...
    tempString = baseString + "W";
    storeNameMap[ li_weight_store ] = tempString;
    tempString = baseString + "VL1";
    storeNameMap[ li_VL1_store ] = tempString;
    tempString = baseString + "VL2";
    storeNameMap[ li_VL2_store ] = tempString;
    tempString = baseString + "VL3";
    storeNameMap[ li_VL3_store ] = tempString;
    if( loadLeadCurrent )
    {
